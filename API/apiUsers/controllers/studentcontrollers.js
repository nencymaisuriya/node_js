...
const addstudents = async (req, res) => {
    try {
        req.body.password = await bcrytpt.hash(req.body.password, 9);
...
const updateStudents = async (req, res) => {
    ...
    try {
        ...
        req.body.password = await bcrytpt.hash(req.body.password, 3);
        if (req.file) {
...
// single data fecth
const fetchSingleStudents = async (req, res) => {
    try {
...
module.exports = {
    addstudents, fetchStudents, DeleteStudents, updateStudents, fetchSingleStudents
}